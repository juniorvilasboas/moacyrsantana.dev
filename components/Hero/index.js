  ...
  return (
    <div className='md:grid md:grid-cols-2 pt-8 mx-auto leading-none'>
      ...
      <div className='realtive'>
        {month + 1 > 11 && (
          <img
            className='absolute z-10 md:-ml-20 h-12 md:h-24'
            src='/images/Bola-natal.png'
          />
        )}
        <div className='z-10'>
          <img
            className='absolute z-10 h-16 ml-2 md:ml-0 lg:ml-8 mt-32 lg:mt-36 animate-bounce'
            src='/images/reactjs.png'
          />
          <img
            className='absolute z-10 h-16 ml-56 md:ml-52 lg:ml-80 mt-14 lg:mt-12 animate-bounce'
            src='/images/nodejs.png'
          />
          <img
            className='absolute z-10 h-16 ml-64 lg:ml-96 mt-52 lg:mt-60 animate-bounce'
            src='/images/javascript.png'
          />
        </div>
        <img
          className='absolute h-64 lg:h-80 md:h-40 ml-12 sm:ml-16 md:ml-0 lg:ml-20 z-0'
