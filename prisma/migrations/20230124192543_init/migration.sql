...
-- AddForeignKey
ALTER TABLE "Skil" ADD CONSTRAINT "Skil_levelId_fkey" FOREIGN KEY ("levelId") REFERENCES "Level"("id") ON DELETE SET NULL ON UPDATE CASCADE;
...
-- AddForeignKey
ALTER TABLE "_PortifolioToSkil" ADD CONSTRAINT "_PortifolioToSkil_B_fkey" FOREIGN KEY ("B") REFERENCES "Skil"("id") ON DELETE CASCADE ON UPDATE CASCADE;
